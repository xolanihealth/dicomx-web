...
function Editor({ onChange, onSubmit, submitting, value }) {
  return (
    <div>
      ...
      <Form.Item>
        <Button
          className="text-[14px] bg-primary border-1 border-primary text-white dark:text-white87 inline-flex items-center justify-center rounded-4 px-[20px] h-[44px] font-semibold shadow-dark"
          htmlType="submit"
          loading={submitting}
          onClick={onSubmit}
          size="default"
