      ...
      <div className="bg-white dark:bg-white10 rounded-[10px]">
        <div className="pt-[30px] px-[30px]">
          ...
          <Progress
            ...
            strokeWidth={5}
            status="primary"
            className="ltr:[&>span.ant-progress-text]:ml-2 rtl:[&>span.ant-progress-text]:mr-2 [&>span.ant-progress-text]:text-body dark:[&>span.ant-progress-text]:text-white60 [&>span.ant-progress-text]:text-xs [&>span.ant-progress-text]:font-medium"
          />
