          ...
          <Col>
            <div className="px-[30px] ssm:px-0 border-b border-regular dark:border-white10">
              ...
              <div className="mt-[22px] min-sm:ltr:pl-[82px] min-sm:rtl:pr-[82px]">
                <span className="inline-block mb-10 text-body dark:text-white60">Hello Adam,</span>
                <p className="min-xs:mb-[55px] xs:mb-[30px] text-body dark:text-white60">{email.body}</p>
