                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mt-[30px] relative items-center flex gap-[8px]">
                      <div className="w-full flex items-center gap-[8px]">
                        ...
                        <input
                          className="h-[70px] border-none rounded-[35px] bg-normalBG dark:bg-normalBGdark ltr:pl-[75px] rtl:pr-[75px] ltr:pr-[25px] rtl:pl-[25px] outline-none placeholder-shown:!text-light dark:placeholder-shown:!text-white60 placeholder-shown:!text-[14px]"
