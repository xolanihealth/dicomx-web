              ...
              <div className="demo placement-confirm p-[25px]">
                <div className="pop-confirm pop-confirm-top gap-[10px] flex flex-wrap whitespace-nowrap min-3xl:ltr:ml-[100px] min-3xl:rtl:mr-[100px] 3xl:mb-[15px]">
                  <Popconfirm placement="topLeft" title={text} onConfirm={onConfirm} okText="Yes" cancelText="No">
                    <Button
                      className="border-solid border-1 hover:text-primary hover:border-primary text-[14px] font-semibold leading-[22px] inline-flex items-center justify-center rounded-4 px-[20px] h-[44px] min-w-[80px]"
                      size="default"
                      type="white"
                      outlined
                    >
                ...
                <div className="pop-confirm pop-confirm-right  flex flex-col gap-[10px] w-[80px] min-3xl:ltr:ml-[380px] min-3xl:rtl:mr-[380px] 3xl:ltr:ml-[180px] 3xl:rtl:mr-[180px]">
                ...
                <div className="pop-confirm pop-confirm-bottom  gap-[10px] flex flex-wrap whitespace-nowrap min-3xl:ltr:ml-[100px] min-3xl:rtl:mr-[100px] 3xl:mt-[15px]">
                  ...
                  <Popconfirm placement="bottom" title={text} onConfirm={onConfirm} okText="Yes" cancelText="No">
                    <Button
                      className="border-solid border-1 hover:text-primary hover:border-primary text-[14px] font-semibold leading-[22px] inline-flex items-center justify-center rounded-4 px-[20px] h-[44px] min-w-[80px] max-w-[80px]"
                      size="default"
                      type="white"
                      outlined
                    >
