    ...
    <Steps
      ...
      steps={[
        ...
        },
        {
          ...
          content:
            status !== 'finish' ? (
              <div className="w-full 3xl:px-[30px]">
                <Heading as="h4" className="mb-[38px] text-xl md:text-lg ssm:text-base font-semibold">
                  4. Review and confirm Order
                </Heading>
                <GlobalUtilityStyle>
                  <div className="p-[25px] rounded-[10px] border border-normal dark:border-white10">
                    <div className="bg-regularBG dark:bg-white10 mb-[25px] p-[25px] rounded-[15px]">
                      <div>
                        <Heading
                          as="h5"
                          className="flex items-center justify-between mb-[22px] text-body dark:text-white60 text-lg font-normal"
                        >
