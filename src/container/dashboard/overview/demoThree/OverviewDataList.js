...
const OverviewDataList = React.memo(() => {
  return (
    <Row>
      <Col xs={24}>
        <div className="flex justify-between flex-wrap gap-[25px] 3xl:gap-[15px] bg-white dark:bg-white10 p-0 text-theme-gray dark:text-white60 text-[15px] rounded-10">
