  ...
  return (
    <GlobalUtilityStyle className="h-full">
      <Cards
        ...
        more={moreContent}
      >
        <div className="pb-[48px] flex items-center justify-center flex-col [%>div>div]:flex [%>div>div]:flex-col [%>div>div]:bg-transparent [&>div>div>.ant-progress-text]:text-primary [&>div>div>.ant-progress-text]:font-semibold p-[25px]">
          <Progress
            type="circle"
            width={230}
            percent={75}
