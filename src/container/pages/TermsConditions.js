    ...
    <>
      ...
      <main className="min-h-[715px] lg:min-h-[580px] bg-transparent px-8 xl:px-[15px] pb-[50px] ssm:pb-[30px]">
        <Row gutter={25}>
          <Col sm={24} xs={24}>
            <div>
              <div className="bg-pink dark:bg-white10 flex justify-center items-center min-h-[330px] md:min-h-[240px] sm:min-h-[150px] rounded-10">
                <h2 className="mb-28 md:mb-0 text-dark dark:text-white87 text-5xl lg:text-4xl md:text-3xl sm:text-[26px] font-semibold">
                  Terms & Conditions
                </h2>
              </div>
              <div className="bg-white dark:bg-[#4b4d56] max-w-[770px] md:max-w-[560px] -mt-32 md:mt-[30px] mx-auto pt-px px-12 sm:px-[30px] pb-12 shadow-custom dark:shadow-none rounded-10">
                <h3 className="mt-12 lg:mt-10 mb-9 lg:mb-5 text-dark dark:text-white87 text-3xl lg:text-[26px] sm:text-2xl font-semibold">
                  Privacy Policy
                </h3>
                <p className="text-body dark:text-white60 text-base leading-7">
                ...
                <p className="text-body dark:text-white60 text-base leading-7">Last update: May 05, 2023</p>
              </div>
            </div>
          </Col>
        </Row>
