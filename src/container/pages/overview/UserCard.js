        ...
        <figcaption>
          ...
          <div className="static flex flex-wrap items-center justify-center gap-[10px]">
            <Button
              ...
              size="default"
            >
              <UilEnvelope className="w-[15px] h-[15px] text-gray dark:text-white87" />
              Message
            </Button>
            <Button
              ...
              size="default"
            >
              <UilUserPlus className="w-[14px] h-[14px] text-light dark:text-white87 group-hover:text-white" />
              Following
            </Button>
          </div>
